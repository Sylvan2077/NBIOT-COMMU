...
void MainWindow::slotconnectedsuccess()
{
    ...
    //将进入聊天的按钮改为离开聊天室
    ui->pushButtonEnter->setText("断开连接");

    int length = 0;
    //将用户名发送给服务器
   // QString msg= userName + ":Enter";
...
void MainWindow::on_pushButtonSend_clicked()
{
    ...
    qDebug() << "send : " << ui->lineEditSend;
    //以UTF-8编码格式发送数据.
    tcpsocket->write(ui->lineEditSend->text().toUtf8());
